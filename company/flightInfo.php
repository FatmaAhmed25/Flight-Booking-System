    ...
    <div class="boarding-pass">
        ...
        <div class="card card-bottom">
            ...
            <div class="card-row">
                <div class="card-row">
                    <div class="card-item">
                        <span class="label">Registered Passengers-
                            <?php echo count($registeredPassengers); ?>
                        </span>
                ...
                <div class="card-item">
                    <span class="label">Pending Passengers-
                        <?php echo count($pendingPassengers); ?>
                    </span>
                    <div class="dropdown">
                ...
                <div class="buttons">
                    <div class="button2">
                        <form method="POST" action="handlePassengers.php?flight_id=<?php echo $flight['ID']; ?>"
                            id="handlePassengersForm">

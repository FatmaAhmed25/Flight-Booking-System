...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($errors) == 0) {
        ...
        if ($result) {
            ...
            array_push($errors, "Error executing the query");
        }
    }
            ...
            <form action="../registration/registration.php" method="post">
                ...
                <div class="row">
                    <div class="radio-option">
                        ...
                        <input type="radio" name="type" value="passenger">
        ...
        <div class="toggle-container">
            <div class="toggle">
                <div class="toggle-panel toggle-left">
                   <img src="../photos/plane.gif" alt="plane illustration" width="400px" height="300px">

...
#confirmationModal.active .modal-box {
  opacity: 1;
  pointer-events: auto;
    ...
    <div class="card card-top">
        ...
        <div class="flight-median">
            ...
            <div class="card-item">
                ...
                <p class="content"><?php echo $flight["Fees"]; ?>$</p>
            </div>
        </div>
...
<!-- 
      ...
      <p>Time: <?php echo date('H:i:s', strtotime($flight["StartDay"])); ?></p> -->
                <div class="card-item">
                    ...
                    <p class="content"><?php echo date('Y-m-d', strtotime($flight["StartDay"])); ?></p>
                </div>

                <div class="card-item">
                    <span class="label">Boarding Time</span>
                    <p class="content"><?php echo date('H:i', strtotime($flight["StartDay"])); ?></p>
                </div>
            ...
            <div class="card-item">
                ...
                <p class="content"><?php echo $flight["PendingPassengers"]; ?></p>
            </div>

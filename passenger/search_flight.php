    ...
    <style>
      @import url("https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap");
        ...
        body {
            margin: 0;
            padding: 0;
            /* background-image: url('../photos/bgSearch.jpg'); Add your background image URL here */
        ...
        .booking__container {
            ...
            z-index: 1; /* Ensure the booking container is above the blur overlay */
        }
        .booking__nav span {
        flex: 1;
        padding: 1rem 2rem;
...
<?php if (!empty($flights)): ?>
  ...
  <?php foreach ($flights as $flight): ?>
    <div class="card">
        <a href="../passenger/flightInfo.php?id=<?php echo $flight['ID']; ?>">
